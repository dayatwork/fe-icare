    ...
    <div className="flex flex-col">
      ...
      <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8 overflow-hidden">
          <div className="shadow border-b border-gray-200 sm:rounded-md mb-20">
            <table
                ...
                {headerGroups.map((headerGroup) => (
                  <tr {...headerGroup.getHeaderGroupProps()}>
                    {headerGroup.headers.map((column) => (
                      <th
                        scope="col"
                        className={`px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hover:text-primary-600 ${
                          dense ? 'py-2' : 'py-3'
                        }`}
