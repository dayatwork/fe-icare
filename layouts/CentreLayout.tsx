...
const navigation = [
  { name: 'Home', href: '/my-centre/customers' },
  { name: 'Cashier', href: '/my-centre/cashier' },
  { name: 'Statistics', href: '/my-centre/statistics' },
]
...
export const CentreLayout: React.FC = ({ children }) => {
