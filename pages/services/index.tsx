...
export default function Services() {
  ...
  return (
    <>
      {/* Search Area */}
      <div className="bg-limeade pt-5 pb-5">
      ...
      <div className="overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 flex space-x-6 py-8 overflow-x-auto">
          {/* Filter */}
          <div className="w-64">
              ...
              <div className="-mt-1 mb-3 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <Listbox value={sortBy} onChange={setSortBy}>
                    {({ open }) => (
                      <>
                        <Listbox.Label className="block font-semibold whitespace-nowrap">
                          Sort by
                        </Listbox.Label>
